...
export const getAllProducts = async (params?: ProductsParams) => {
    try{
        ...
        if (params) {
            ...
            if (params.price__gte) queryParams.append('price__gte', params.price__gte);
            if (params.price__lte) queryParams.append('price__lte', params.price__lte);
...
export const getInventory = async (params?: InventoryParams) => {
    try{
        ...
        if (params) {
            ...
            if (params.is_out_of_stock) queryParams.append('is_out_of_stock', params.is_out_of_stock);
            if (params.is_low_stock) queryParams.append('is_low_stock', params.is_low_stock);
        }
